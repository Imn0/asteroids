...
inline int mtx_init(mtx_t* __mutex, int __type) {
    UNUSED(__mutex);
    UNUSED(__type);
    return thrd_success;
}
inline int cnd_init(cnd_t* __cond) {
    UNUSED(__cond);
    return thrd_success;
}
inline void mtx_destroy(mtx_t* __mutex) { UNUSED(__mutex); }
inline int mtx_lock(mtx_t* __mutex) {
    UNUSED(__mutex);
    return thrd_success;
}
inline int mtx_unlock(mtx_t* __mutex) {
    UNUSED(__mutex);
    return thrd_success;
}
inline int cnd_signal(cnd_t* __cond) {
    UNUSED(__cond);
    return thrd_success;
}
